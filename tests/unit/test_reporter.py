...
class TestBuildFinding:
    def test_required_keys_present(self) -> None:
        ...
        f = build_finding("http://t.example", "http://t.example/api",
                          status="confirmed")
    ...
    def test_cve_present_when_given(self) -> None:
        from spring2shell.core.reporter import build_finding
        f = build_finding("http://t.example", "http://t.example/api",
                          status="confirmed", cve="CVE-2021-44228")
...
class TestBuildSiemSchemaReport:
    def test_schema_envelope(self) -> None:
        from spring2shell.core.reporter import build_siem_schema_report, build_finding
        findings = [build_finding("http://t.example", "http://t.example/api",
                                  status="confirmed")]
...
class TestWriteReport:
    def test_write_report_creates_json(self, tmp_path: Path) -> None:
        from spring2shell.core.reporter import write_report, build_finding
        findings = [build_finding("http://t.example", "http://t.example/api",
                                  status="confirmed")]
    ...
    def test_write_txt_report_creates_file(self, tmp_path: Path) -> None:
        from spring2shell.core.reporter import write_txt_report, build_finding
        findings = [build_finding("http://t.example", "http://t.example/api",
                                  status="confirmed", evidence="uid=0")]
    ...
    def test_write_dual_report_returns_both_paths(self, tmp_path: Path) -> None:
        from spring2shell.core.reporter import write_dual_report, build_finding
        findings = [build_finding("http://t.example", "http://t.example/api",
                                  status="unverified")]
...
class TestPrintSummary:
    def test_does_not_raise(self, capsys) -> None:
        from spring2shell.core.reporter import print_summary, build_finding
        findings = [
